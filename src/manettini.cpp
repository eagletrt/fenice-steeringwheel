...
void Manettini::setMap(int val) { this->map = val; }
void Manettini::setTc(int val) { this->tc = val; }
void Manettini::setPump(int val) { this->pump = val; }
void Manettini::setFirstChange() { firstChange = false; }
int Manettini::getMap() const { return this->map; }
int Manettini::getTc() const { return this->tc; }
